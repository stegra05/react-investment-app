...
function TrackingSection() {
    return (
        <section id="tracking" className="mb-16 scroll-mt-16" data-aos="fade-up">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6 border-b pb-2 border-gray-300 dark:border-gray-600">Tracking Your Portfolio</h2>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold mb-3 text-indigo-700 dark:text-indigo-400 flex items-center">
                    <span className="lucide mr-2" style={{ fontSize: '1.1rem' }}>&#xe9c4;</span> Keep an Eye on Your Investments
                </h3>
                <div className="text-gray-700 dark:text-gray-300 space-y-4 text-sm">
                    <p>Regularly monitoring your portfolio is crucial to ensure it stays aligned with your goals and risk tolerance. Check its performance and allocation at least annually, or more often if market conditions change significantly.</p>
